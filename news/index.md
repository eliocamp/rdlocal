...
- [`i18n_module_update()`](https://eliocamp.github.io/rdlocal/reference/i18n_module_update.md)
...
- Help pages are shown in the reader’s language, with install- and
  ...
  installation.
- Added
  [`read_translations()`](https://eliocamp.github.io/rdlocal/reference/read_translations.md)
  (#14, thanks @maelle).
